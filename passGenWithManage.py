...
def save_password_to_file(password, filename):
    ...
    filepath = os.path.join("Passwords", f"{filename}.txt")

    with open(filepath, "w") as file:
        file.write(password)

    print(Y2+f"Contraseña guardada en: {RED}{filepath}{R1}")
...
"""+ R1)    
    ...
    try:
        ...
        filename = input(Y2+"Ingrese el nombre del archivo para guardar la contraseña (ej. 'CuentaGoogle'): "+R1)
